		...
		<MainLayout>
			...
			>
				...
				<Form.Item label="Display Nama" required>
					<Controller name="displayNama" control={control} rules={{ required: 'Wajib mengisi display nama' }} render={({ field }) => <Input {...field} placeholder="Masukkan nama display" />} />
				</Form.Item>

				<Form.Item label="Nama Penandatangan" required>
					<Controller name="atasNama" control={control} rules={{ required: 'Wajib mengisi Nama' }} render={({ field }) => <Input {...field} placeholder="Masukkan nama Penandatangan" />} />
				</Form.Item>
          ...
          />
				...
				<Form.Item label="Link logo Perusahaan" required>
					<Controller
						...
						render={({ field }) => (
							<>
								<Input {...field} placeholder="Masukkan Link Gambar" style={{ width: '100%', height: '50px' }} />
