...
const CertificateTable = () => {
	...
	return (
		<div className="p-4 sm:p-10">
			<h1 className="text-2xl sm:text-2xl font-bold text-center mb-8 text-[#15467a]">Verifikasi Sertifikat</h1>
			<div className="max-w-3xl mx-auto bg-white overflow-hidden text-[12px]">
				...
				<div className="grid sm:grid-cols-2 grid-cols-1 gap-0 border border-gray-300">
					{/* Row 1 */}
					<div className="sm:p-4 pt-4 px-8 bg-[#f8fafc] font-bold border-t sm:border-r">No. Sertifikat</div>
					...
					{/* Row 7 */}
					<div className="sm:p-4 pt-4 px-8 bg-[#f8fafc] font-bold sm:border-r">Lihat Sertifikat</div>
					<div className="sm:p-4 pb-4 px-8 py-2 bg-[#f8fafc]">
						<button onClick={() => downloadPDF(certificate?.data?.data_id)} className="bg-green-500 text-white px-4 py-2 hover:bg-green-600">
							Lihat Sertifikat
						</button>
					</div>
				</div>
