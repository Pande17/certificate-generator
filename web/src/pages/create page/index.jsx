...
function MyForm() {
	...
	const onSubmit = async (formData) => {
		...
		try {
			...
			const response = await axios.post('http://127.0.0.1:3000/api/certificate', formattedData);
		...
		<MainLayout>
			...
			>
				...
				<Form.Item label="Nama sertifikat" required>
					<Controller name="sertifikat" control={control} rules={{ required: 'Nama is required' }} render={({ field }) => <Input {...field} placeholder="Masukkan nama" style={{ width: '100%', height: '50px' }} />} />
				</Form.Item>
				<Form.Item label="Nama" required>
					<Controller name="nama" control={control} rules={{ required: 'Nama is required' }} render={({ field }) => <Input {...field} placeholder="Masukkan nama" style={{ width: '100%', height: '50px' }} />} />
				</Form.Item>

				<Form.Item label="Field of Study" required>
					<Controller name="fieldOfStudy" control={control} rules={{ required: 'Field of Study is required' }} render={({ field }) => <Input {...field} placeholder="Masukkan field of study" style={{ width: '100%', height: '50px' }} />} />
				</Form.Item>
				...
				<Form.Item label="Expired Time (Start)" required>
					<Controller
						...
						render={({ field }) => <DatePicker {...field} placeholder="Pilih expired time start" style={{ width: '100%', height: '50px' }} />}
					/>
				</Form.Item>
				...
				<Form.Item label="Expired Time (End)" required>
					<Controller
						...
						render={({ field }) => <DatePicker {...field} placeholder="Pilih expired time end" style={{ width: '100%', height: '50px' }} />}
					/>
				</Form.Item>

				<Form.Item label="Code Referral (Order)" required>
					<Controller name="codeReferralOrder" control={control} rules={{ required: 'Code Referral (Order) is required' }} render={({ field }) => <InputNumber {...field} placeholder="0" style={{ width: '100%', height: '50px' }} />} />
				</Form.Item>
				...
				<Form.Item label="Code Referral (Field of Study)" required>
					<Controller
						...
						render={({ field }) => <Input {...field} placeholder="Masukkan code referral (field of study)" style={{ width: '100%', height: '50px' }} />}
					/>
				</Form.Item>
				...
				<Form.Item label="Code Referral (Month)" required>
					<Controller
						...
						render={({ field }) => <Input {...field} placeholder="Masukkan code referral (month)" style={{ width: '100%', height: '50px' }} />}
					/>
				</Form.Item>
				...
				<Form.Item label="Code Referral (Year)" required>
					<Controller
						...
						render={({ field }) => <Input {...field} placeholder="Masukkan code referral (year)" style={{ width: '100%', height: '50px' }} />}
					/>
				</Form.Item>

				<Form.Item label="SKKNI" required>
					<Controller name="skkni" control={control} rules={{ required: 'SKKNI is required' }} render={({ field }) => <Input {...field} placeholder="Masukkan SKKNI" style={{ width: '100%', height: '50px' }} />} />
				</Form.Item>
				...
				<Form.Item label="Total Meeting" required>
					<Controller
						...
						render={({ field }) => <InputNumber {...field} placeholder="Masukkan total meeting" style={{ width: '100%', height: '50px' }} />}
					/>
				</Form.Item>

				<Form.Item label="Meeting Time" required>
					<Controller name="meetingTime" control={control} rules={{ required: 'Meeting Time is required' }} render={({ field }) => <Input {...field} placeholder="Masukkan meeting time" style={{ width: '100%', height: '50px' }} />} />
				</Form.Item>
